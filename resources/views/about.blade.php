...
<div class="bg-white dark:bg-gray-900">
    ...
    <div class="bg-yellow-400 dark:bg-yellow-600">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="text-center">
                <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-4">{{ $aboutData['title'] }}</h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="flex flex-col md:flex-row items-center">
            <div class="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                ...
                <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-4">Our Mission</h3>
    ...
    <div class="bg-gray-100 dark:bg-gray-800">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center">Our Values</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Quality</h3>
                    <p class="text-gray-600 dark:text-gray-300">
                        We are committed to providing only the highest quality, freshest fruits to our customers.
                    </p>
                </div>
                ...
                <div class="bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Sustainability</h3>
                    <p class="text-gray-600 dark:text-gray-300">
                        We support sustainable farming practices and work with farmers who share our commitment to the environment.
                    </p>
                </div>
    ...
    <!-- Our Team Section -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center">Meet Our Team</h2>
    ...
    <div class="bg-yellow-400 dark:bg-yellow-600">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
            <h2 class="text-3xl font-bold text-gray-900 dark:text-white mb-4">Ready to Work With Us?</h2>
