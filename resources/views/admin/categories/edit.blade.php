<x-layout.app>
    <x-slot:header>
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('admin.edit_category') }}: {{ $category->translate(app()->getLocale())->name }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <x-admin.form :action="route('admin.categories.update', $category)" method="PUT" novalidate>
                        ...
                        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800 mb-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="en_name" name="en[name]" type="text" class="mt-1 block w-full" :value="old('en.name', $category->translate('en')->name ?? '')" />
                        ...
                        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800 mb-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="th_name" name="th[name]" type="text" class="mt-1 block w-full" :value="old('th.name', $category->translate('th')->name ?? '')" />
                        ...
                        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800 mb-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="zh_name" name="zh[name]" type="text" class="mt-1 block w-full" :value="old('zh.name', $category->translate('zh')->name ?? '')" />
