                        ...
                        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800 mb-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="en_name" name="en[name]" type="text" class="mt-1 block w-full" :value="old('en.name', $category->translate('en')->name ?? '')" required />
                        ...
                        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800 mb-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="th_name" name="th[name]" type="text" class="mt-1 block w-full" :value="old('th.name', $category->translate('th')->name ?? '')" required />
                        ...
                        <div class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800 mb-6">
                            ...
                            <div class="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <x-text-input id="zh_name" name="zh[name]" type="text" class="mt-1 block w-full" :value="old('zh.name', $category->translate('zh')->name ?? '')" required />
