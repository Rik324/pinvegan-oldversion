                        ...
                        <div x-show="open"
                            ...
                            <div class="py-1 bg-white rounded-md ring-1 ring-black ring-opacity-5">
                                @foreach($navCategories as $category)
                                    <a href="{{ route('fruits.index') }}?locale={{ app()->getLocale() }}&category_id={{ $category->id }}&sort=name&direction=asc" class="block px-4 py-2 text-sm leading-5 text-gray-700 transition duration-150 ease-in-out hover:bg-gray-100 focus:outline-none focus:bg-gray-100">
                                        {{ $category->name }}
                                    </a>
                                @endforeach
                            </div>
