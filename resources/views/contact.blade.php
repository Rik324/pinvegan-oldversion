<x-layout.app>
    <x-slot:header>
        <h2 class="mt text-xl font-semibold leading-tight text-yellow-300 dark:text-gray-200">
                ...
                <div class="space-y-6">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <svg class="w-6 h-6 text-green-800 dark:text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
